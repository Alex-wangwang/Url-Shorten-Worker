const config = {
  password: "uzr7dvrkiz8mv8yg4xkh", // 管理面板使用密码 // if password != null, then use this config; otherwise, read password from KV.
...
let index_html = "https://Alex-wangwang.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
